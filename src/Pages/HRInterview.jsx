...
function HRInterview() {
  ...
  const loadQuestions = async () => {
    try {
      const data = await api.getQuestions("hr");
  ...
  const handleSubmit = async () => {
    ...
    try {
      const currentQ = questions[currentIndex]?.question || "Tell me about yourself and your background.";
      const data = await api.submitAnswer("hr", currentQ, answer);
      if (data.success) {
  ...
  const currentQuestion = questions[currentIndex] || { id: 1, question: "Tell me about yourself and your background." };

  return (
    <div className="page-container">
      <div className="page-content">
        <h1>👔 HR Interview Module</h1>
        <p>Practice HR interview questions and receive soft skill AI evaluations.</p>
